...
void PWMSetSpeed(float vitesseEnPourcents, int NUM)
{
    if (NUM == MOTEUR_GAUCHE) {
...
void PWMSetSpeedConsigne(float vitesseEnPourcentage, unsigned char moteur)
{
